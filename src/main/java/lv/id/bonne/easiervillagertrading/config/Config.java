	...
	static void init()
	{
		...
		buttonType = ConfigurationLoader.CLIENT_BUILDER.
			comment(" There are 3 types of button: " +
                "\n\t ORIGINAL_BUTTON, that was implemented in original mod. " +
                "\n\t ORIGINAL_BUTTON_NO_ENCHANT, original button without enchant text. " +
                "\n\t COMPACT_BUTTON with Minecraft button design.").
		...
		panelSide = ConfigurationLoader.CLIENT_BUILDER.
			comment(" All recipe buttons can be positioned in 3 sides: " +
                "\n\t LEFT_SIDE, RIGHT_SIDE and TOP_SIDE.").
