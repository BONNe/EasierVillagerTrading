...
//        System.out.println("icons=" + BetterGuiMerchant.icons);
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        for (int i = 0; i < trades.size(); i++)
        {
            ...
            drawItem(i1, this.xBase + this.firstBuyItemXpos, i * this.lineHeight - topAdjust + this.titleDistance);
            drawItem(i2, this.xBase + this.secondBuyItemXpos, i * this.lineHeight - topAdjust + this.titleDistance);
            drawItem(o1, this.xBase + this.sellItemXpos, i * this.lineHeight - topAdjust + this.titleDistance);
        ...
        this.mc.getTextureManager().bindTexture(BetterGuiMerchant.icons);         // arrows; use standard item lighting for them so we need a separate loop
...
// tooltips
        ...
        for (int i = 0; i < trades.size(); i++)
        {
            ...
            ItemStack i2 = trade.hasSecondItemToBuy() ? trade.getSecondItemToBuy() : null;
            ItemStack o1 = trade.getItemToSell();
            drawTooltip(i1, this.xBase + this.firstBuyItemXpos, i * this.lineHeight - topAdjust + this.titleDistance, mouseX, mouseY);
            drawTooltip(i2, this.xBase + this.secondBuyItemXpos, i * this.lineHeight - topAdjust + this.titleDistance, mouseX, mouseY);
            drawTooltip(o1, this.xBase + this.sellItemXpos, i * this.lineHeight - topAdjust + this.titleDistance, mouseX, mouseY);
        }
    }
